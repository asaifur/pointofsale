...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/hmd') ?>assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= base_url('assets/hmd/') ?>assets/css/bootstrap-icons.css">
    <link rel="stylesheet" href="<?= base_url('assets/hmd/') ?>assets/css/style.css">
</head>
...
<body>
    ...
    <script src="<?= base_url('assets/hmd/') ?>assets/js/bootstrap.bundle.min.js"></script>
    <script src="<?= base_url('assets/hmd/') ?>assets/js/main.js"></script>
</body>
